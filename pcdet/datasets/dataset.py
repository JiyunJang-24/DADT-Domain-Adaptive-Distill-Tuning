...
class DatasetTemplate(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, use_ori=False, logger=None, is_distill = False):
        super().__init__()
        ...
        dict1 = edict()
        if self.use_ori and self.dataset_cfg['DATASET'] == 'NuScenesDataset':
            dict1['NAME'] = 'random_beam_upsample'
            dict1['BEAM'] = 32
            dict1['BEAM_PROB'] = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]
            dict1['PHI_THRESHOLD'] = 0.03
            self.dataset_cfg.DATA_AUGMENTOR['AUG_CONFIG_LIST'].insert(0, dict1)
        ...
        self.data_processor = DataProcessor(
            ...
            is_teacher = self.use_ori, is_distill = is_distill
        )
    ...
    def prepare_data(self, data_dict):
        ...
        if data_dict.get('gt_boxes', None) is not None:
            ...
            # if data_dict.get('gt_scores', None) is not None:
