...
class NuScenesDataset(DatasetTemplate):
    ...
    """
    def __init__(self, dataset_cfg, class_names, training=True, use_ori=False, teacher_tag=None, root_path=None, logger=None, is_distill=False):
        ...
        if 'DATA_SIZE' in self.dataset_cfg and self.training:
            data_size = dataset_cfg['DATA_SIZE']
            data_size = float(data_size.strip('%')) / 100.0
            ...
            if self.oss_path is None:
                ...
                with open(info_path, 'rb') as f:
                    ...
                    if self.data_size:
                        ...
                        split_index = int(self.data_size * len(infos))
                        infos = infos[:split_index]
