...
def build_dataloader_lidar_distill(dataset_cfg, class_names, batch_size, dist, root_path=None, workers=4,
                     logger=None, training=True, merge_all_iters_to_one_epoch=False, total_epochs=0, use_ori=None, set_sampler=None, teacher_tag='default', is_distill = False):
    ...
    if use_ori is None:
        ...
        ### use ori = True for teacher model 
        dataset = __all__[dataset_cfg.DATASET](
            dataset_cfg=dataset_cfg,
            class_names=class_names,
            root_path=root_path,
