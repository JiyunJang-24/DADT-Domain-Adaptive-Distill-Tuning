...
class DataProcessor(object):
    def __init__(self, processor_configs, point_cloud_range, training, num_point_features, is_teacher = False, is_distill = False):
    ...
    def transform_points_to_voxels(self, data_dict=None, config=None):
        ...
        points = data_dict['points']
        if not self.is_teacher and self.is_distill and self.training: 

            voxels_list = []
            voxel_coords_list = []
            voxel_num_points_list = []
            
            _points_yflip, _points_xflip, _points_xyflip = self.double_flip(
                    points
                )
            points_list = [
                points,
